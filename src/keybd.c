...
{
  swinput_debug ( "swkeybd_keyPress  key = %d\n", key );
...
{
  swinput_debug ( "swkeybd_keyRelease  key = %d\n", key );
 ...
 * Name:        swkeybd_write
 *
 * Description: write accepts data and converts it to one or many key presses
 *
 */
